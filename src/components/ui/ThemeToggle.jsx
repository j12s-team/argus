...
export default function ThemeToggle({ className = '', size = 'md' }) {
  ...
  return (
    <button
      ...
      className={`${sz} inline-flex items-center justify-center rounded-pill border border-argus-border bg-transparent text-argus-fg-soft hover:text-argus-accent hover:border-argus-accent/60 transition-colors ${className}`}
    >
